;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="d6bf25ea-8349-76f5-ea22-c19aa124678e")}catch(e){}}();
module.exports=[918622,(e,t,a)=>{t.exports=e.x("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js",()=>require("next/dist/compiled/next-server/app-page-turbo.runtime.prod.js"))},556704,(e,t,a)=>{t.exports=e.x("next/dist/server/app-render/work-async-storage.external.js",()=>require("next/dist/server/app-render/work-async-storage.external.js"))},832319,(e,t,a)=>{t.exports=e.x("next/dist/server/app-render/work-unit-async-storage.external.js",()=>require("next/dist/server/app-render/work-unit-async-storage.external.js"))},324725,(e,t,a)=>{t.exports=e.x("next/dist/server/app-render/after-task-async-storage.external.js",()=>require("next/dist/server/app-render/after-task-async-storage.external.js"))},193695,(e,t,a)=>{t.exports=e.x("next/dist/shared/lib/no-fallback-error.external.js",()=>require("next/dist/shared/lib/no-fallback-error.external.js"))},814747,(e,t,a)=>{t.exports=e.x("path",()=>require("path"))},750227,(e,t,a)=>{t.exports=e.x("node:path",()=>require("node:path"))},925372,(e,t,a)=>{t.exports=e.x("better-sqlite3",()=>require("better-sqlite3"))},762294,e=>{"use strict";var t=e.i(925372);let a=e.i(814747).default.resolve(process.cwd(),"data","viewcomfy.sqlite"),r=new t.default(a);r.pragma("foreign_keys = ON"),e.s(["VIEWCOMFY_DATABASE_PATH",0,a,"db",0,r])},959195,e=>{"use strict";var t=e.i(750227),a=e.i(762294);class r{listAlbums(){return this.ensureAlbumTables(),a.db.prepare(`
        ...
        `),a.db.prepare("PRAGMA table_info(assets)").all().some(e=>"album_id"===e.name)||a.db.exec(`
            ...
            `),a.db.exec("CREATE INDEX IF NOT EXISTS idx_assets_album_id ON assets(album_id);")}}e.s(["AssetLibraryService",()=>r])},122203,e=>{"use strict";var t=e.i(747909),a=e.i(174017),r=e.i(996250),s=e.i(759756),n=e.i(561916),i=e.i(114444),l=e.i(837092),o=e.i(869741),d=e.i(316795),u=e.i(487718),p=e.i(995169),m=e.i(47587),c=e.i(666012),E=e.i(570101),b=e.i(626937),h=e.i(10372),R=e.i(193695);e.i(52474);var T=e.i(600220),A=e.i(89171);let f=new(e.i(959195)).AssetLibraryService;async function _(e){try{let t=await e.json();if(!Array.isArray(t.ids)||0===t.ids.length)return A.NextResponse.json({ok:!1,error:"参数 ids 无效"},{status:400});let a=t.ids.map(e=>Number(e)).filter(e=>Number.isInteger(e)&&e>0);if(0===a.length)return A.NextResponse.json({ok:!1,error:"参数 ids 无效"},{status:400});let r=null;if("default"===t.albumId)r=null;else{let e=Number(t.albumId);Number.isInteger(e)&&e>0&&(r=e)}if(null===r&&"default"!==t.albumId)return A.NextResponse.json({ok:!1,error:"参数 albumId 无效"},{status:400});let s=f.moveAssetsToAlbum(a,r);return A.NextResponse.json({ok:!0,movedCount:s})}catch(t){let e=t instanceof Error?t.message:"Unknown move error";return A.NextResponse.json({ok:!1,error:e},{status:500})}}e.s(["POST",()=>_],558961);var x=e.i(558961);let v=new t.AppRouteRouteModule({definition:{kind:a.RouteKind.APP_ROUTE,page:"/api/assets/batch-move/route",pathname:"/api/assets/batch-move",filename:"route",bundlePath:""},distDir:".next",relativeProjectDir:"",resolvedPagePath:"[project]/app/api/assets/batch-move/route.ts",nextConfigOutput:"standalone",userland:x}),{workAsyncStorage:N,workUnitAsyncStorage:S,serverHooks:I}=v;function g(){return(0,r.patchFetch)({workAsyncStorage:N,workUnitAsyncStorage:S})}async function C(e,t,r){v.isDev&&(0,s.addRequestMeta)(e,"devRequestTimingInternalsEnd",process.hrtime.bigint());let A="/api/assets/batch-move/route";A=A.replace(/\/index$/,"")||"/";let f=await v.prepare(e,t,{srcPage:A,multiZoneDraftMode:!1});if(!f)return t.statusCode=400,t.end("Bad Request"),null==r.waitUntil||r.waitUntil.call(r,Promise.resolve()),null;let{buildId:_,params:x,nextConfig:N,parsedUrl:S,isDraftMode:I,prerenderManifest:g,routerServerContext:C,isOnDemandRevalidate:w,revalidateOnlyGenerated:y,resolvedPathname:L,clientReferenceManifest:O,serverActionsManifest:U}=f,M=(0,o.normalizeAppPath)(A),P=!!(g.dynamicRoutes[M]||g.routes[L]),D=async()=>((null==C?void 0:C.render404)?await C.render404(e,t,S,!1):t.end("This page could not be found"),null);if(P&&!I){let e=!!g.routes[L],t=g.dynamicRoutes[M];if(t&&!1===t.fallback&&!e){if(N.experimental.adapterPath)return await D();throw new R.NoFallbackError}}let k=null;!P||v.isDev||I||(k="/index"===(k=L)?"/":k);let q=!0===v.isDev||!P,H=P&&!q;U&&O&&(0,i.setReferenceManifestsSingleton)({page:A,clientReferenceManifest:O,serverActionsManifest:U,serverModuleMap:(0,l.createServerModuleMap)({serverActionsManifest:U})});let j=e.method||"GET",F=(0,n.getTracer)(),$=F.getActiveScopeSpan(),K={params:x,prerenderManifest:g,renderOpts:{experimental:{authInterrupts:!!N.experimental.authInterrupts},cacheComponents:!!N.cacheComponents,supportsDynamicResponse:q,incrementalCache:(0,s.getRequestMeta)(e,"incrementalCache"),cacheLifeProfiles:N.cacheLife,waitUntil:r.waitUntil,onClose:e=>{t.on("close",e)},onAfterTaskError:void 0,onInstrumentationRequestError:(t,a,r)=>v.onRequestError(e,t,r,C)},sharedContext:{buildId:_}},B=new d.NodeNextRequest(e),W=new d.NodeNextResponse(t),X=u.NextRequestAdapter.fromNodeNextRequest(B,(0,u.signalFromNodeResponse)(t));try{let i=async e=>v.handle(X,K).finally(()=>{if(!e)return;e.setAttributes({"http.status_code":t.statusCode,"next.rsc":!1});let a=F.getRootSpanAttributes();if(!a)return;if(a.get("next.span_type")!==p.BaseServerSpan.handleRequest)return void console.warn(`Unexpected root span type '${a.get("next.span_type")}'. Please report this Next.js issue https://github.com/vercel/next.js`);let r=a.get("next.route");if(r){let t=`${j} ${r}`;e.setAttributes({"next.route":r,"http.route":r,"next.span_name":t}),e.updateName(t)}else e.updateName(`${j} ${A}`)}),l=!!(0,s.getRequestMeta)(e,"minimalMode"),o=async s=>{var n,o;let d=async({previousCacheEntry:a})=>{try{if(!l&&w&&y&&!a)return t.statusCode=404,t.setHeader("x-nextjs-cache","REVALIDATED"),t.end("This page could not be found"),null;let n=await i(s);e.fetchMetrics=K.renderOpts.fetchMetrics;let o=K.renderOpts.pendingWaitUntil;o&&r.waitUntil&&(r.waitUntil(o),o=void 0);let d=K.renderOpts.collectedTags;if(!P)return await (0,c.sendResponse)(B,W,n,K.renderOpts.pendingWaitUntil),null;{let e=await n.blob(),t=(0,E.toNodeOutgoingHttpHeaders)(n.headers);d&&(t[h.NEXT_CACHE_TAGS_HEADER]=d),!t["content-type"]&&e.type&&(t["content-type"]=e.type);let a=void 0!==K.renderOpts.collectedRevalidate&&!(K.renderOpts.collectedRevalidate>=h.INFINITE_CACHE)&&K.renderOpts.collectedRevalidate,r=void 0===K.renderOpts.collectedExpire||K.renderOpts.collectedExpire>=h.INFINITE_CACHE?void 0:K.renderOpts.collectedExpire;return{value:{kind:T.CachedRouteKind.APP_ROUTE,status:n.status,body:Buffer.from(await e.arrayBuffer()),headers:t},cacheControl:{revalidate:a,expire:r}}}}catch(t){throw(null==a?void 0:a.isStale)&&await v.onRequestError(e,t,{routerKind:"App Router",routePath:A,routeType:"route",revalidateReason:(0,m.getRevalidateReason)({isStaticGeneration:H,isOnDemandRevalidate:w})},C),t}},u=await v.handleResponse({req:e,nextConfig:N,cacheKey:k,routeKind:a.RouteKind.APP_ROUTE,isFallback:!1,prerenderManifest:g,isRoutePPREnabled:!1,isOnDemandRevalidate:w,revalidateOnlyGenerated:y,responseGenerator:d,waitUntil:r.waitUntil,isMinimalMode:l});if(!P)return null;if((null==u||null==(n=u.value)?void 0:n.kind)!==T.CachedRouteKind.APP_ROUTE)throw Object.defineProperty(Error(`Invariant: app-route received invalid cache entry ${null==u||null==(o=u.value)?void 0:o.kind}`),"__NEXT_ERROR_CODE",{value:"E701",enumerable:!1,configurable:!0});l||t.setHeader("x-nextjs-cache",w?"REVALIDATED":u.isMiss?"MISS":u.isStale?"STALE":"HIT"),I&&t.setHeader("Cache-Control","private, no-cache, no-store, max-age=0, must-revalidate");let p=(0,E.fromNodeOutgoingHttpHeaders)(u.value.headers);return l&&P||p.delete(h.NEXT_CACHE_TAGS_HEADER),!u.cacheControl||t.getHeader("Cache-Control")||p.get("Cache-Control")||p.set("Cache-Control",(0,b.getCacheControlHeader)(u.cacheControl)),await (0,c.sendResponse)(B,W,new Response(u.value.body,{headers:p,status:u.value.status||200})),null};$?await o($):await F.withPropagatedContext(e.headers,()=>F.trace(p.BaseServerSpan.handleRequest,{spanName:`${j} ${A}`,kind:n.SpanKind.SERVER,attributes:{"http.method":j,"http.target":e.url}},o))}catch(t){if(t instanceof R.NoFallbackError||await v.onRequestError(e,t,{routerKind:"App Router",routePath:M,routeType:"route",revalidateReason:(0,m.getRevalidateReason)({isStaticGeneration:H,isOnDemandRevalidate:w})}),P)throw t;return await (0,c.sendResponse)(B,W,new Response(null,{status:500})),null}}e.s(["handler",()=>C,"patchFetch",()=>g,"routeModule",()=>v,"serverHooks",()=>I,"workAsyncStorage",()=>N,"workUnitAsyncStorage",()=>S],122203)}];

//# debugId=d6bf25ea-8349-76f5-ea22-c19aa124678e
//# sourceMappingURL=%5Broot-of-the-server%5D__d511bffe._.js.map